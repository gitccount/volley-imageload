 ...
 * associated request.
 */
public class NetworkImageViewRound extends ImageView {
	...
	public NetworkImageViewRound(Context context) {
		this(context, null);
	}

	public NetworkImageViewRound(Context context, AttributeSet attrs) {
	 ...
	 * {@link NetworkImageViewRound#setDefaultImageResId(int)} on the view.
	 * 
	 * NOTE: If applicable,
	 * {@link NetworkImageViewRound#setDefaultImageResId(int)} and
	 * {@link NetworkImageViewRound#setErrorImageResId(int)} should be called
